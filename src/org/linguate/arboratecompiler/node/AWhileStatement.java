...
{
    private PWhileCondition _whileCondition_;
    ...
    public AWhileStatement(
        @SuppressWarnings("hiding") PWhileCondition _whileCondition_,
        @SuppressWarnings("hiding") List<?> _statement_)
    {
        // Constructor
        setWhileCondition(_whileCondition_);
    ...
    public Object clone()
    {
        return new AWhileStatement(
            cloneNode(this._whileCondition_),
    ...
    public PWhileCondition getWhileCondition()
    {
        return this._whileCondition_;
    }

    public void setWhileCondition(PWhileCondition node)
    {
        if(this._whileCondition_ != null)
        {
            this._whileCondition_.parent(null);
        }
    ...
    {
        return ""
            + toString(this._whileCondition_)
    ...
    {
        // Remove child
        if(this._whileCondition_ == child)
        {
            this._whileCondition_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._whileCondition_ == oldChild)
        {
            setWhileCondition((PWhileCondition) newChild);
            return;
        }
