...
public final class AOtherwiseIfSegment extends PIfSegment
{
    private final LinkedList<PStatement> _statement_ = new LinkedList<PStatement>();

    public AOtherwiseIfSegment()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOtherwiseIfSegment(
    ...
    {
        ((Analysis) sw).caseAOtherwiseIfSegment(this);
    }
