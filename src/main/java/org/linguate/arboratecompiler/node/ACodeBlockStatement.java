...
public final class ACodeBlockStatement extends PStatement
{
    private final LinkedList<PStatement> _statement_ = new LinkedList<PStatement>();

    public ACodeBlockStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACodeBlockStatement(
    ...
    {
        ((Analysis) sw).caseACodeBlockStatement(this);
    }
